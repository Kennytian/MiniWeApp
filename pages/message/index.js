...
Page({
  ...
  onShow() {
    ...
    setTimeout(() => {
      ...
      this.setData(this.data.val + 1);
      console.debug('one', this.data.val);

      this.setData(this.data.val + 1);
      console.debug('two', this.data.val);

      this.setData(this.data.val + 1);
      console.debug('three', this.data.val);

      this.setData(this.data.val + 1);
      console.debug('four', this.data.val);
    }, 1);
